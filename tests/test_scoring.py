...
def test_heuristic_solver():
    ...
    assert agm.alpha_beta(test_board_cp, cm.PLAYER1, True, 0, -1000, 1000)[1] == 2
    ...
    test_board_cp = test_board.copy()
    assert agm.alpha_beta(test_board_cp, cm.PLAYER2, True, 0, -1000, 1000)[1] == 6
    ...
    test_board_cp = test_board.copy()
    assert not agm.alpha_beta(test_board_cp, cm.PLAYER2, True, 0, -1000, 1000)[1] == 2
    ...
    print(board_str)
    test_board_cp = test_board.copy()
    assert agm.alpha_beta(test_board_cp, cm.PLAYER2, True, 0, -1000, 1000)[1] == 3
    ...
    print(board_str)
    test_board_cp = test_board.copy()
    assert agm.alpha_beta(test_board_cp, cm.PLAYER1, True, 0, -1000, 1000)[1] == 6
    ...
    print(board_str)
    test_board_cp = test_board.copy()
    assert agm.alpha_beta(test_board_cp, cm.PLAYER1, True, 0, -1000, 1000)[1] == 4
